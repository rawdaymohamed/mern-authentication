        ...
        >
            <div className='p-8 flex flex-col gap-5'>
                ...
                <form onSubmit={handleRegister} className='flex flex-col gap-3'>
                    ...
                    <Link href="/forgot-password" className='text-green-500 text-sm hover:underline'>Forgot password?</Link>
                ...
                <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
                    <p className='text-sm text-gray-400'>Don't have an acccount? {" "}
                        <Link href="/register" className='text-green-500 hover:underline'>Register</Link></p>
